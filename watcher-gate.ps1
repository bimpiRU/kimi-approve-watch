...
$res = $wshell.Popup("Запустить Kimi Approve Watcher?`n`nБудет подтверждать 'Approve once' в окнах Kimi каждые 10 сек и не давать ПК заснуть.`nБез подтверждения работа не начнётся. (ожидание 120 сек)", 120, 'Kimi Approve Watch', 4 + 64 + 4096)
